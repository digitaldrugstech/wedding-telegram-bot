...
async def help_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if category == "main":
        ...
        text = (
            ...
            "/business — бизнес (покупка + прокачка)\n"
            "/bank — вклад под 2% в неделю\n"
            "/assets — обзор империи\n"
            ...
            "• Открывай и прокачивай бизнесы\n"
            "• Вкладывай в банк для пассивного дохода"
        )
